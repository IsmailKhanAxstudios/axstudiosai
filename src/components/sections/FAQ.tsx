...
// Floating tech elements
const floatingElements = [
  { icon: Hexagon, x: "5%", y: "15%", duration: 6, delay: 0 },
  { icon: Circle, x: "95%", y: "10%", duration: 7, delay: 1 },
  { icon: Triangle, x: "90%", y: "85%", duration: 8, delay: 2 },
  { icon: Cpu, x: "8%", y: "80%", duration: 5, delay: 0.5 },
  { icon: Network, x: "50%", y: "5%", duration: 9, delay: 1.5 },
  { icon: Zap, x: "50%", y: "95%", duration: 6.5, delay: 2.5 },
];
      ...
      {floatingElements.map((element) => (
        ...
        >
          <element.icon
            ...
            style={{
              color: PRIMARY,
              filter: `drop-shadow(0 0 10px ${PRIMARY_GLOW})`,
            }}
          />
        </motion.div>
      ))}
