...
//             <span className="text-sm text-zinc-300">THE PROBLEM</span>
//           </motion.div>

//           <h2 className="text-3xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
//             Manual work is <span className="text-red-400">costing you.</span>
//           </h2>
...
//                       isHovered || isSelected ? "66" : "22"
//                     }`,
//                     boxShadow:
//                       isHovered || isSelected
//                         ? `0 0 25px ${problem.color}33`
//                         : "none",
...
//                     style={{
//                       background: `${problem.color}22`,
//                       border: `1px solid ${problem.color}44`,
//                     }}
//                   >
//                     <problem.icon
//                       className="w-6 h-6"
...
//                     style={{ borderColor: `${problem.color}22` }}
//                   >
//                     <span
...
//           <a
//             href="/contact"
//             className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-gradient-to-r from-red-600 to-purple-600 text-white font-medium transition-all hover:scale-105 hover:shadow-lg hover:shadow-red-500/25"
//           >
